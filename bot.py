"""
1HZ25V EVEN/ODD 5-TICK BOT
============================
Trades DIGITEVEN / DIGITODD on 1HZ25V with 5-tick expiry.
...
class Hz25vEOBot:
    ...
    async def run(self):
        log.info("=" * 65)
        log.info("1HZ25V EVEN/ODD 5-TICK BOT")
