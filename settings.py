"""
1HZ25V EVEN/ODD 5-TICK BOT — SETTINGS
=========================================
Contract : DIGITEVEN / DIGITODD on 1HZ25V
Expiry   : 5 ticks
Symbol   : 1HZ25V (Volatility 25 (1s) Index)

NOTE ON DIGIT EXTRACTION:
  1HZ25V prices have 2 decimal places, e.g. 1234.56
  Last digit = int(round(price * 10)) % 10  → same formula as R_10.
  Verified: the contract settles on the last digit of the raw quote.
...
LOG_FILE            = "/tmp/1hz25v_eo_bot.log"
TRADES_FILE         = "/tmp/1hz25v_eo_trades.csv"
STATS_FILE          = "/tmp/1hz25v_eo_stats.json"
