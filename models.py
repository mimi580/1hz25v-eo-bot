...
DIGIT EXTRACTION:
  1HZ25V prices look like 1234.56 → last digit = 6 (from int(price*10) % 10)
...
def extract_digit(price: float) -> int:
    """Extract last digit from 1HZ25V price. e.g. 1234.56 → 6"""
...
def model_A1_frequency(prices: np.ndarray) -> ModelResult:
    ...
    This makes the model responsive to regime shifts — if 1HZ25V
